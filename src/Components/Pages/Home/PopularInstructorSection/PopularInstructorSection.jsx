...
const PopularInstructorSection = () => {
    ...
    const enrolledStudent = instructors?.filter((student) => student.enrolled)
            ...
            <div className='w-full mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                {
                    ...
                    >
                        ...
                        <img className='w-full max-w-[300px] h-48 mx-auto mb-5' src={classItem?.photo} alt="classname image" />
