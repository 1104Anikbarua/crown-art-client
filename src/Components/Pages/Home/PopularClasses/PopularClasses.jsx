        ...
        <div className='bg-fuchsia-100 w-full h-60 mt-20'>
            <div className='w-full max-w-7xl h-60 mx-auto flex items-center justify-center'>
                ...
                <div className='w-full max-w-7xl flex flex-col h-40 items-center justify-center hover:text-orange-100'>
                    ...
                    <GiHeavyThornyTriskelion className='text-[40px] hover:text-orange-100'></GiHeavyThornyTriskelion>
                    <p className='font-playfair text-2xl font-bold '>Potraits</p>

                </div>
                <p className='h-20 border-2 border-zinc-400'></p>
                <div className='w-full max-w-7xl flex flex-col h-40 items-center justify-center hover:text-orange-100'>
                    <TbChartRadar className='text-[40px] hover:text-orange-100'></TbChartRadar>
                ...
                <div className='w-full max-w-7xl flex flex-col h-40 items-center justify-center hover:text-orange-100'>
                    ...
                    <GiTigerHead className='text-[40px] hover:text-orange-100'></GiTigerHead>
                ...
                <div className='w-full max-w-7xl flex flex-col h-40 items-center justify-center hover:text-orange-100'>
                    ...
                    <BsBuildings className='text-[40px] hover:text-orange-100'></BsBuildings>
                ...
                <div className='w-full max-w-7xl flex flex-col h-40 items-center justify-center hover:text-orange-100'>
                    ...
                    <GiAbstract119 className='text-[40px] hover: custom-hover'></GiAbstract119>
                    <p className='font-playfair text-2xl font-bold '>Abstract Art</p>
